  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <kbd class="bg-aqua"><b>Conectado:</b>
                  <span class="hidden-xs">{{ Auth::user()->name }}</span></kbd>
                </a>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2015-2020 <a href="https://www.linkedin.com/in/contedenis" target="_blank"><i class="fa fa-linkedin-square" aria-hidden="true"></i> ConteDenis</a>.</strong> All rights reserved.
      </footer>
