...
class VentaController extends Controller
{
    ...
    public function create()
    {
    	...
    	$articulos = DB::table('articulo as art')
    		...
    		->select(DB::raw('CONCAT(art.codigo, " ", art.nombre) AS articulo'), 'art.idarticulo', 'art.stock', DB::raw('avg(di.precio_venta) as precio_promedio')) //para hacer un promedio de todos los precios ingresados, si quiero el ultimo solo tengo que modificar esta ultima consulta
